        ...
        <nav className={styles.navbar}>
          <div className={styles.left}>
            ...
            <div className={styles.search_bar}>
              <IoSearchOutline size='18px' color='#65676B' className='ml-1' />
              <input
                type='text'
          ...
          <div className={styles.center}>
            <ul className={styles.nav_icons}>
              <li className={styles.list_icons}>
                <Link href='#' className={styles.icons_link} id={styles.active}>
                  <svg
                    viewBox='0 0 24 24'
                    width='24'
                    height='24'
              ...
              <li className={styles.list_icons}>
                <Link href='#' className={styles.icons_link}>
                  <svg
                    viewBox='0 0 24 24'
                    width='24'
                    height='24'
          ...
          <div className={styles.right}>
            <ul className={styles.right_nav_icons}>
              <li className={styles.right_icon}>
